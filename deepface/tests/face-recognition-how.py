...
img1 = functions.preprocess_face(r'C:\Users\doank\PycharmProjects\deepface\data\doan\doan1.jpg', input_shape)
img1_representation = model.predict(img1)[0, :]

#img2 = functions.detectFace("dataset/img3.jpg", input_shape)
img2 = functions.preprocess_face(r'C:\Users\doank\PycharmProjects\deepface\data\doan\doan4.jpg', input_shape)
